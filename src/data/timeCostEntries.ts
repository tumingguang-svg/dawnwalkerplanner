...
export const TIME_COST_ENTRIES: TimeCostEntry[] = [
  ...
  },
  {
    ...
    phase: "day",
    verificationStatus: "reported",
    notes: "PC Gamer 2⌛. Conservative default vs IGN XP-focus. Gamer Guides: poor prologue ROI — prefer expiring NPC sides.",
    lastVerified: "2026-09-05",
    sourceNote: `${SOURCE_URLS.pcgamerPrologue} ${SOURCE_URLS.gamerGuidesPrologueBest}`,
    gameVersion: "retail launch week Sep 2026",
    youtubeSource: YT_IGN_PROLOGUE,
  },
  {
  ...
  },
  {
    ...
    verificationStatus: "reported",
    notes:
      "Blasphemy, Someone Needs A Lesson, Disturbed (base), Into The Den, Like Father Like Son, Page-Turner stay, bandit-camp engage. Falcon: hangouts may add extra. ROI: Like Father → Charge Manual; Blasphemy can double-dip Premysl+Gremla; Into The Den / bandit camp reported to persist after prologue (Gamer Guides) — prefer Mass-day spend on expiring NPC quests.",
    lastVerified: "2026-09-05",
    sourceNote: `${SOURCE_URLS.pcgamerPrologue} Falcon YT ${YT_FALCON_TIME.url} ${SOURCE_URLS.gamerGuidesPrologueBest}`,
    gameVersion: "retail launch week Sep 2026",
  ...
  },
  {
    ...
    verificationStatus: "reported",
    notes:
      "Polygon lists 2 for the Laslea Glen treasure chain. Camp engage alone is 1 (IGN). GameSpot split may differ. Persist conflict: PowerPyx prologue-missable list vs Gamer Guides buried-treasure persists — Pending; do not auto-defer.",
    lastVerified: "2026-09-05",
    sourceNote: `${SOURCE_URLS.polygonMassQuests} ${SOURCE_URLS.gamespotPrologue} ${SOURCE_URLS.gamerGuidesPrologueBest}`,
    gameVersion: "retail launch week Sep 2026",
    youtubeSource: YT_IGN_PROLOGUE,
  },
];
